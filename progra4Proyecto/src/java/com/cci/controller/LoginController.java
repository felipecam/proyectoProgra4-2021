...
public class LoginController implements Serializable {
    ...
    private String filtroRemitente;
    ...
    public String getFiltroRemitente() {
        return filtroRemitente;
    }

    public void setFiltroRemitente(String filtroRemitente) {
...
//    }
    ...
    public String ingresar() throws IOException, MessagingException, GlobalException {
        LoginService loginService = new LoginService();
        usuarioData = loginService.BuscarPorUsuarioPassword(this.usuario, this.clave);
        if (usuarioData != null) {

            this.listaCorreo = loginService.ListaCorreos();
    ...
    public String regitraUsuario() throws IOException, MessagingException, GlobalException {
        LoginService loginService = new LoginService();
...
//    }
    ...
    public void actualizarCorreo() throws GlobalException {
        LoginService ls = new LoginService();
        this.listaCorreo = ls.ListaCorreos();
    }
